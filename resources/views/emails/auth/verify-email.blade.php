@php
    ...
    $content = $content ?? \App\Support\EmailContent::load()['verify_email'];
@endphp
<!doctype html>
<html lang="en">
<head>
    ...
    <title>Confirm your {{ $brand }} email address</title>
</head>
                    ...
                    <tr>
                        <td style="padding:30px 28px;">
                            ...
                            <p style="margin:26px 0;">
                                <a href="{{ $verificationUrl }}" style="display:inline-block;background:{{ $primaryColor }};color:#ffffff;text-decoration:none;font-weight:700;padding:13px 20px;border-radius:6px;">{{ $content['button_label'] }}</a>
                            </p>
                            <p style="margin:0;font-size:14px;line-height:1.6;color:#526173;">{{ $content['note'] }}</p>
                        </td>
                    </tr>
                    <tr>
