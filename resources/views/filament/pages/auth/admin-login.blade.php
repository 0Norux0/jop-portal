        ...
        <section class="flex min-h-screen flex-col px-4 py-6 sm:px-6 lg:px-10">
            ...
            <div class="mx-auto flex w-full max-w-xl flex-1 items-center py-8">
                <div class="admin-login-card w-full p-5 sm:p-7">
                    <div class="admin-login-mobile-brand mb-6 items-center gap-3">
                        ...
                        <form action="/jobs" method="GET" class="flex h-12 min-w-0 flex-1 items-center overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
                            <input name="q" value="{{ request('q') }}" class="h-full min-w-0 flex-1 border-0 bg-transparent px-4 text-sm text-slate-800 placeholder:text-slate-400 focus:ring-0" placeholder="Search jobs">
                            <button type="submit" class="flex h-full items-center px-4 text-white" style="background: {{ $primary }};">
                                <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                    <path d="m20 20-4.2-4.2m1.2-5.3a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                                </svg>
                            </button>
